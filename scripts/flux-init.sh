...
# https://raw.githubusercontent.com/swade1987/gitops-with-kustomize/master/scripts/flux-init.sh
...
REPO_GIT_INIT_PATHS="namespaces/"
REPO_ROOT=$(git rev-parse --show-toplevel)
REPO_URL=${1:-git@github.com:chaunceyt/gitops-demo}
REPO_BRANCH=master
TEMP=${REPO_ROOT}/temp
